...
In this project, I will be using a recipe dataset to make inferences and predictions based on included data and some user input. You can find the full report in the file Report (.docx file). All datasets, graph and codes are included in the corresponding folders.
